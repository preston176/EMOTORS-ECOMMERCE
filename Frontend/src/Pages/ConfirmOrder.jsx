...
const ConfirmOrder = () => {
  ...
  const { isAuth, handleUserAuth, userDetails, setUserDetails } =
  ...
  const handlePayment = (e) => {
    ...
    fetch("http://localhost:3000/mpesa", {
      ...
      body: JSON.stringify({
        ...
        Password:
          "MTc0Mzc5YmZiMjc5ZjlhYTliZGJjZjE1OGU5N2RkNzFhNDY3Y2QyZTBjODkzMDU5YjEwZjc4ZTZiNzJhZGExZWQyYzkxOTIwMjQwMjE5MTM0NjU4",
  ...
  const processOrder = () => {
    ...
    fetch("http://localhost:3000/process_order", {
      ...
      body: JSON.stringify({
        ...
        items: [
          {
            product_id: selectedBike.id,
            quantity: quantity,
            price_per_unit: selectedBike.price,
          },
        ],
      }),
    })
      ...
      <table className="table">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <img className="bike-image" src={selectedBike.image} alt="" />
            </td>
